const projectsArray = [
  ...
  },
  {
    ...
    screenshots: [
      ...
      "/images/floodguard/image_15.png",
    ],
    ...
    demoVideo: "/videos/Floodguard.mp4",
  ...
  },
  {
    ...
    screenshots: [
      ...
      "/images/orakgarak/recommend.png",
      "/images/orakgarak/recommend_detail.png",
      "/images/orakgarak/Album.png",
      "/images/orakgarak/Album_Create.png",
      "/images/orakgarak/feed.png",
      "/images/orakgarak/tracklist.png",
      "/images/orakgarak/AIDemo.png",
    ],
  ...
  },
  {
    ...
    longDescription:
      "React와 Tailwind CSS를 활용하여 제작한 개인 포트폴리오 웹사이트입니다. Intersection Observer API 기반 스크롤 애니메이션, 타이핑 효과, 3D 호버 이펙트 등 다양한 인터랙티브 요소를 구현하여 사용자 경험을 극대화했습니다. 컴포넌트 기반 아키텍처로 설계하여 재사용성과 유지보수성을 높였으며, 완전한 반응형 디자인으로 모든 디바이스에서 최적화된 화면을 제공합니다. SEO 최적화, 이미지 최적화, 코드 스플리팅 등 성능 최적화를 적용하여 빠른 로딩 속도와 검색 엔진 노출을 개선했습니다.",
    role: "프론트엔드 개발 (React 기반 SPA 구현, 컴포넌트 설계, 인터랙티브 UI 개발, 성능 최적화)",
    tech: [
      "React 19",
      "Vite",
      "React Router v7",
    ...
    techDetails: [
      ...
      },
      {
        ...
        reason: "페이지별 코드 스플리팅으로 초기 번들 사이즈 축소 및 로딩 시간 단축",
      },
      {
        name: "vite-plugin-imagemin",
        reason: "빌드 시 이미지 자동 압축 및 WebP 변환으로 로딩 속도 개선",
      },
    ],
    ...
    achievements: [
      ...
      "SEO 최적화 (메타 태그, OG 태그, sitemap.xml, robots.txt) 적용으로 검색 엔진 최적화 및 소셜 미디어 공유 미리보기 지원",
      "React.lazy와 Suspense를 활용한 페이지별 코드 스플리팅으로 초기 번들 사이즈 최적화 및 vendor/icons 청크 분리",
      "vite-plugin-imagemin을 통한 빌드 시 이미지 자동 압축 및 lazy loading 적용으로 이미지 로딩 성능 개선",
      "폰트 preload/preconnect 적용으로 LCP(Largest Contentful Paint) 개선 및 초기 렌더링 속도 향상",
    ],
    challenges: [
      ...
      "Vite 빌드 최적화 설정: terser minifier 사용 시 Vite v3부터 선택적 의존성으로 변경되어 빌드 실패가 발생했습니다. 기본 minifier인 esbuild로 전환하고, rollupOptions에서 vendor와 icons 청크를 수동 분리하여 캐싱 효율성을 높이고 빌드 안정성을 확보했습니다.",
    ],
    demo: null,
    tags: ["Frontend", "React", "Tailwind CSS", "Performance Optimization", "Personal"],
  },
  {
    id: 5,
